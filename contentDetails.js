...
function dynamicContentDetails(ob)
{
    ...
    qtyDiv.style.margin = '1em 0';
    let qtyLabel = document.createElement('label');
    qtyLabel.innerText = 'Quantity:';
    qtyLabel.setAttribute('for', 'qtyInput');
    qtyLabel.style.marginRight = '0.5em';
    let qtyInput = document.createElement('input');
    qtyInput.type = 'number';
    qtyInput.id = 'qtyInput';
    qtyInput.min = 1;
    qtyInput.max = ob.stock || 99;
    qtyInput.value = 1;
    qtyInput.style.width = '60px';
    qtyInput.style.padding = '0.3em';
    ...
    buttonTag.onclick = function() {
        ...
        if (quantity > (ob.stock || 99)) quantity = ob.stock || 99;
        // Store cart as JSON in localStorage for better quantity management
    ...
    productDetailsDiv.appendChild(qtyDiv);
